...
export function FirstMoveCard({ variant }: Props) {
    ...
    return (
      <section className="g-first-move" aria-label="Get started">
        ...
        <p className="g-first-move__body">
          Scout different parts of your District to find Specialists and Enforcers. Specialists
          generate Cash. Enforcers protect your Empire and fight for you.
        </p>
  ...
  return (
    <section className="g-first-move" aria-label="Next step">
      ...
      <p className="g-first-move__body">
        Keep scouting, or visit the Shop to arm your Enforcers and stock Specialist Kits.
      </p>
