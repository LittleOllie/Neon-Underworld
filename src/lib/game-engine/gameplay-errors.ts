...
export const GAMEPLAY_ERROR_MESSAGES: Record<GameplayErrorCode, string> = {
  ...
  INVALID_FORCE: 'Enter a valid number of Enforcers.',
  ...
  TARGET_OUT_OF_RANGE: 'That Operator is outside your attack range.',
  ...
  CARTEL_ALREADY_MEMBER: 'You are already in a Faction.',
  CARTEL_FULL: 'This Faction is full.',
  CARTEL_INVITE_INVALID: 'This Faction invite is no longer valid.',
  CARTEL_NOT_LEADER: 'Only the Faction leader can do that.',
  CARTEL_NAME_TAKEN: 'That Faction name is already taken.',
  CARTEL_TAG_TAKEN: 'That Faction tag is already taken.',
  CARTEL_JOIN_REQUEST_INVALID: 'This join request is no longer valid.',
  CARTEL_JOIN_REQUEST_EXISTS: 'You already have a pending request for this Faction.',
  CARTEL_NOT_MEMBER: 'That player is not in your Faction.',
  ...
  POACH_TARGET_TOO_SMALL: 'This player does not have enough Specialists to extract.',
};
...
export const GAMEPLAY_CONTEXT_MESSAGES = {
  ...
  intelTargetOutOfRange: 'This Operator is below your attack range.',
  intelTargetAboveRange: 'This Operator is above your attack range.',
  attackTargetNowOutOfRange: 'That Operator is now outside your attack range.',
  belowAttackRangeHeading: 'BELOW YOUR ATTACK RANGE',
  aboveAttackRangeHeading: 'ABOVE YOUR ATTACK RANGE',
} as const;
